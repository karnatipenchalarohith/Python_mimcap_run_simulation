...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 18 14:30:06 2022
...
def createnetlist_temp(wt, lt, mt, Voltage_start, Voltage_stop, Voltage_step, hertz, Temp, lib_path, corner, modelname, terminals):
    filename = "netlist_temp.sp"
    ...
    with open(filename, 'w') as f:
        ...
        f.write('.ac lin 1 ' + str(hertz) + ' 10k sweep temp ' + str(Voltage_start) +
